...
export interface PersonalDetails {
  ...
  gender: "MALE" | "FEMALE" | "OTHER" | "NOT_STATED"; nationality: string; countryOfBirth: string;
...
export interface EntryDetails {
  ...
  scholarshipInterest: boolean; scholarshipNotes: string;
}
...
export interface AcademicDetails {
  ...
  attendanceTo: string; curriculum: "BRITISH" | "NIGERIAN" | "AMERICAN" | "IB" | "MONTESSORI" | "OTHER";
  currentYearGroup: string; reasonForLeaving: string; headteacherName: string; schoolEmail: string; schoolPhone: string;
...
export const initialAdmissionData: AdmissionFormData = {
  personal: { legalFirstName: "", legalLastName: "", preferredName: "", dateOfBirth: "", gender: "NOT_STATED", nationality: "Nigerian", countryOfBirth: "Nigeria", religion: "", firstLanguage: "English", additionalLanguages: "", applicantEmail: "", applicantPhone: "" },
  entry: { academicYear: "2026/2027", yearGroup: "YEAR_7", entryTerm: "AUTUMN", pupilType: "DAY", currentSchoolYear: "", proposedStartDate: "2026-09-08", scholarshipInterest: false, scholarshipNotes: "" },
  ...
  academic: { previousSchoolName: "", previousSchoolAddress: "", previousSchoolCountry: "Nigeria", attendanceFrom: "", attendanceTo: "", curriculum: "BRITISH", currentYearGroup: "", reasonForLeaving: "", headteacherName: "", schoolEmail: "", schoolPhone: "", englishProficiency: "FLUENT", learningStrengths: "", supportHistory: "", permissionToContactSchool: false },
